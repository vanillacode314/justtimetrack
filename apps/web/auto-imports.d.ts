...
declare global {
  ...
  const ProjectDashboard: typeof import('./src/components/ProjectDashboard')['ProjectDashboard']
  ...
  const Selectable: typeof import('./src/components/Selectable')['Selectable']
  ...
  const ToastComp: typeof import('./src/components/Toast')['ToastComp']
  ...
  const actionSchema: typeof import('./src/stores/index')['actionSchema']
  const appStateSchema: typeof import('./src/stores/index')['appStateSchema']
  ...
  const differenceBy: typeof import('./src/utils/index')['differenceBy']
  const drawer: typeof import('./src/components/Drawer')['default']
  const exportToJsonFile: typeof import('./src/utils/index')['exportToJsonFile']
  const fab: typeof import('./src/components/Fab')['default']
  const fadeIn: typeof import('./src/utils/animations')['fadeIn']
  const formatSeconds: typeof import('./src/utils/index')['formatSeconds']
  const formatTimeToString: typeof import('./src/utils/index')['formatTimeToString']
  const getFile: typeof import('./src/utils/index')['getFile']
  ...
  const longpress: typeof import('./src/utils/use-longpress')['longpress']
  const mapArray: typeof import('solid-js')['mapArray']
  const mergeBy: typeof import('./src/utils/index')['mergeBy']
  ...
  const removeProject: typeof import('./src/stores/index')['removeProject']
  ...
  const setActions: typeof import('./src/stores/index')['setActions']
  ...
  const uniqBy: typeof import('./src/utils/index')['uniqBy']
  ...
  const userStateSchema: typeof import('./src/stores/index')['userStateSchema']
